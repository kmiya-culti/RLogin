...
static uint64_t load64(const unsigned char *x)
{
	...
	val  = (unsigned long long)x[0];
	val |= (unsigned long long)x[1] << 8;
	val |= (unsigned long long)x[2] << 16;
	val |= (unsigned long long)x[3] << 24;
	val |= (unsigned long long)x[4] << 32;
	val |= (unsigned long long)x[5] << 40;
	val |= (unsigned long long)x[6] << 48;
	val |= (unsigned long long)x[7] << 56;
	return val;
#else
