...
static const BYTE KakoTab[19][7][2] = {
	{ { 90, 5 }, { 78, 13 }, { 70, 22 }, { 60, 35 }, { 55, 50 }, { 50, 75 }, { 50, 100 }  },	// ⎛	(U+239B)
	{ { 50, 0 }, { 50, 20 }, { 50, 40 }, { 50, 50 }, { 50, 60 }, { 50, 80 }, { 50, 100 }  },	// ⎜	(U+239C)
	{ { 50, 0 },   { 50, 25 }, { 55, 50 }, { 60, 65 }, { 70, 78 }, { 78, 87 }, { 90, 95 } },	// ⎝	(U+239D)
	{ { 10, 5 }, { 22, 13 }, { 30, 22 }, { 40, 35 }, { 45, 50 }, { 50, 75 }, { 50, 100 }  },	// ⎞	(U+239E)
	{ { 50, 0 }, { 50, 20 }, { 50, 40 }, { 50, 50 }, { 50, 60 }, { 50, 80 }, { 50, 100 }  },	// ⎟	(U+239F)
	{ { 50, 0 },   { 50, 25 }, { 45, 50 }, { 40, 65 }, { 30, 78 }, { 22, 87 }, { 10, 95 } },	// ⎠	(U+23A0)

	{ { 90, 10 }, { 50, 10 }, { 50, 20 }, { 50, 40 }, { 50, 60 }, { 50, 80 }, { 50, 100 } },	// ⎡	(U+23A1)
	{ { 50, 0 }, { 50, 20 }, { 50, 40 }, { 50, 50 }, { 50, 60 }, { 50, 80 }, { 50, 100 }  },	// ⎢	(U+23A2)
	{ { 50, 0 },   { 50, 20 }, { 50, 40 }, { 50, 60 }, { 50, 80 }, { 50, 90 }, { 90, 90 } },	// ⎣	(U+23A3)
	{ { 10, 10 }, { 50, 10 }, { 50, 20 }, { 50, 40 }, { 50, 60 }, { 50, 80 }, { 50, 100 } },	// ⎤	(U+23A4)
	{ { 50, 0 }, { 50, 20 }, { 50, 40 }, { 50, 50 }, { 50, 60 }, { 50, 80 }, { 50, 100 }  },	// ⎥	(U+23A5)
	{ { 50, 0 },   { 50, 20 }, { 50, 40 }, { 50, 60 }, { 50, 80 }, { 50, 90 }, { 10, 90 } },	// ⎦	(U+23A6)

	{ { 63, 22 }, { 58, 23 }, { 56, 26 }, { 54, 30 }, { 52, 35 }, { 50, 40 }, { 50, 100 } },	// ⎧	(U+23A7)
	{ { 50, 0 }, { 50, 43 }, { 44, 47 }, { 34, 50 }, { 44, 53 }, { 50, 57 }, { 50, 100 }  },	// ⎨	(U+23A8)
	{ { 50, 0 },   { 50, 60 }, { 52, 65 }, { 54, 70 }, { 56, 74 }, { 58, 77 }, { 63, 78 } },	// ⎩	(U+23A9)
	{ { 50, 0 }, { 50, 20 }, { 50, 40 }, { 50, 50 }, { 50, 60 }, { 50, 80 }, { 50, 100 }  },	// ⎪	(U+23AA)
	{ { 37, 22 }, { 42, 23 }, { 44, 26 }, { 46, 30 }, { 48, 35 }, { 50, 40 }, { 50, 100 } },	// ⎫	(U+23AB)
	{ { 50, 0 }, { 50, 43 }, { 56, 47 }, { 66, 50 }, { 56, 53 }, { 50, 57 }, { 50, 100 }  },	// ⎬	(U+23AC)
	{ { 50, 0 },   { 50, 60 }, { 48, 65 }, { 46, 70 }, { 44, 74 }, { 42, 77 }, { 37, 78 } },	// ⎭	(U+23AD)
};
#endif
