...
#define	CHECKOPTMAX		10
#define	IDC_CHECKFAST	IDC_OPTCHECK1
static const int CheckOptTab[] = { TO_RLDELAY, TO_RLBPLUS, TO_RLDSECHO, TO_RLPOFF, TO_RLKEEPAL, TO_SLEEPTIMER, TO_RLGROUPCAST, TO_RLNTBCRECV, TO_RLNTBCSEND, TO_RLNOTCLOSE };
