...
const COLORREF	ColSetTab[COLSETTABMAX][16] = {
	{	RGB(  0,   0,	0), RGB(196,  64,  64), RGB( 64, 196,  64), RGB(196, 196,  64),
		RGB(112, 112, 224), RGB(196,  64, 196), RGB( 64, 196, 196), RGB(196, 196, 196),
		RGB(128, 128, 128), RGB(255,  96,  96), RGB( 96, 255,  96), RGB(255, 255,  96),
		RGB(134, 134, 255), RGB(255,  96, 255), RGB( 96, 255, 255), RGB(255, 255, 255)	},	// Black

	{	RGB( 10,   5,   0), RGB(206,  62,  51), RGB( 74, 181,  51), RGB(206, 181,  51), 
		RGB(122, 105, 179), RGB(206,  62, 156), RGB( 74, 181, 156), RGB(206, 181, 156), 
		RGB(138, 120, 102), RGB(255,  87,  73), RGB(106, 234,  76), RGB(255, 225,  73), 
		RGB(144, 125, 204), RGB(255,  87, 196), RGB(106, 234, 204), RGB(255, 225, 196), },	// Amber

	{	RGB(  0,  10,   0), RGB(156,  74,  51), RGB( 51, 206,  51), RGB(156, 206,  51), 
		RGB( 89, 122, 179), RGB(156,  74, 156), RGB( 51, 206, 156), RGB(156, 206, 156), 
		RGB(102, 138, 102), RGB(204, 106,  76), RGB( 73, 255,  73), RGB(196, 255,  73), 
		RGB(107, 144, 204), RGB(204, 106, 204), RGB( 73, 255, 196), RGB(196, 255, 196), },	// Green

	{	RGB(  0,   5,  10), RGB(156,  62,  74), RGB( 51, 181,  74), RGB(156, 181,  74), 
		RGB( 89, 105, 234), RGB(156,  62, 206), RGB( 51, 181, 206), RGB(156, 181, 206), 
		RGB(102, 120, 138), RGB(204,  91, 106), RGB( 76, 234, 106), RGB(204, 234, 106), 
		RGB(102, 120, 255), RGB(196,  87, 255), RGB( 73, 225, 255), RGB(196, 225, 255), },	// Sian

	{	RGB(255, 255, 255), RGB(196,  64,  64), RGB( 32, 128,   0), RGB(128, 128,   0),
		RGB(  0,  64, 128), RGB(196,   0, 196), RGB(  0, 128, 128), RGB(  0,   0,   0),
		RGB(224, 224, 224), RGB(255,  32,  32), RGB( 32, 224,   0), RGB(164, 164,   0),
	...
	{	RGB( 33,  34,  44), RGB(255,  85,  85), RGB( 80, 250, 123), RGB(241, 250, 140),
		...
		RGB(214, 172, 255), RGB(255, 146, 223), RGB(164, 255, 255), RGB(255, 255, 255)	},	// Dracula
};
