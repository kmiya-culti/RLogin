...
static const struct _iso646tab {
	...
	{ _T("US (ANSI X3.4-1968)"),			8514,	{ 0x0023, 0x0024, 0x0040, 0x005B, 0x005C, 0x005D, 0x005E, 0x0060, 0x007B, 0x007C, 0x007D, 0x007E, 0x005F } },
	{ _T("JP (JIS X 0201)"),				8518,	{ 0x0023, 0x0024, 0x0040, 0x005B, 0x00A5, 0x005D, 0x005E, 0x0060, 0x007B, 0x007C, 0x007D, 0x203E, 0x005F } },
	...
	{ _T("NO-2 (NS 4551 version 2)"),		8517,	{ 0x00A7, 0x0024, 0x0040, 0x00C6, 0x00D8, 0x00C5, 0x02C6, 0x0060, 0x00E6, 0x00F8, 0x00E5, 0x007C, 0x005F } },
	{ _T("FI (SFS 4017)"),					1018,	{ 0x0023, 0x00A4, 0x0040, 0x00C4, 0x00D6, 0x00C5, 0x02C6, 0x0060, 0x00E4, 0x00F6, 0x00E5, 0x02DC, 0x005F } },
	{ _T("SE-C (SEN 85 02 00 Annex C)"),	8516,	{ 0x0023, 0x00A4, 0x00C9, 0x00C4, 0x00D6, 0x00C5, 0x00DC, 0x00E9, 0x00E4, 0x00F6, 0x00E5, 0x00FC, 0x005F } },
	{ _T("DE (DIN 66003)"),					8515,	{ 0x0023, 0x0024, 0x00A7, 0x00C4, 0x00D6, 0x00DC, 0x02C6, 0x0060, 0x00E4, 0x00F6, 0x00FC, 0x00DF, 0x005F } },
	...
	{ _T("French (NRCS)"),					8511,	{ 0x00A3, 0x0024, 0x00E0, 0x00B0, 0x00E7, 0x00A7, 0x005E, 0x0060, 0x00E9, 0x00F9, 0x00E8, 0x00A8, 0x005F } },	// R	f
	{ _T("French Canadian (NRCS)"),			8512,	{ 0x0023, 0x0024, 0x00E0, 0x00E2, 0x00E7, 0x00EA, 0x00EE, 0x00F4, 0x00E9, 0x00F9, 0x00E8, 0x00FB, 0x005F } },	// 9	Q
	{ _T("Japanese Roman (NRCS)"),			8513,	{ 0x0023, 0x0024, 0x0040, 0x005B, 0x00A5, 0x005D, 0x005E, 0x0060, 0x007B, 0x007C, 0x007D, 0x203E, 0x005F } },
...
void CIso646Dlg::CodePageList(CStringArray &stra)
{
	CString name;

	for ( int n = 0 ; Iso646Tab[n].name != NULL ; n++ ) {
		name.Format(_T("CP0%d %s"), Iso646Tab[n].ccsid, Iso646Tab[n].name);
		stra.Add(name);
	}
}
